...
// get variable
  ...
  // ================================================================
  // PROSES BACKGROUND INTERCEPT (DENGAN REFRESH OTOMATIS BERSIH)
  // ================================================================
  if ($removesecr != "" || $enablesecr != "" || $disablesecr != "") {
  ...
  if ($removepactive != "") {
    ...
    echo "<script>window.location.href='./?ppp=active&session=" . $session . "';</script>";
    exit();
  }
  // ================================================================
...
// redirect to home
  elseif (substr(explode("=", $url)[0],-9) == "/?session" && !isset($_GET['ppp'])) {
